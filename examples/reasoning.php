...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Function to highlight think tags content with tags included
        ...
        echo nl2br(htmlspecialchars_decode(htmlspecialchars($highlighted)));
        echo "</div>";
...
<form method="post" class="mt-6 space-y-4">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            <label for="frequency_penalty" class="block text-sm font-medium text-gray-700 mb-1">Frequency Penalty (-2.0 - 2.0)</label>
